...
export const ContentWrapper = styled.div`
  ...
  @media (max-width: 1200px) {
    padding: 20px 40px; // Add more padding on smaller screens
  }

  @media (max-width: 768px) {
    padding: 20px 20px; // Adjust padding for tablets
  }
...
export const Title = styled.h1`
  ...
  @media (max-width: 1200px) {
    font-size: 42px; // Reduce font size on smaller screens
    margin-top: 80px; // Adjust margin for smaller screens
  }

  @media (max-width: 768px) {
    font-size: 36px; // Further reduce font size for tablets
...
export const Subtitle = styled.p`
  ...
  @media (max-width: 768px) {
    font-size: 14px; // Further reduce font size for tablets
  }
