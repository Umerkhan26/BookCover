                ...
                <ReviewsWrapper>
                    <CardsWrapper>
                        ...
                        <ReviewCard>
                            ...
                            <p className="mt-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum aliquid quo eum quae quos illo earum ipsa doloribus nostrum minus libero aspernatur laborum cum, a suscipit, ratione ea totam ullam!</p>
                        </ReviewCard>
                        ...
                        <ReviewCard>
                            <div className="flex gap-4">
                                <img className="w-12 h-12 rounded-full" src="https://randomuser.me/api/portraits/men/22.jpg" alt="user avatar" width="200" height="200" loading="lazy" />
                                <div>
                                    <h6 className="text-lg font-medium text-gray-700 dark:text-white">John Smith</h6>
                                    <p className="text-sm text-gray-500 dark:text-gray-300">Designer</p>
                                    <div className="flex text-yellow-500">
                                        <span>⭐</span>
                                        <span>⭐</span>
                                        <span>⭐</span>
                            ...
                            <p className="mt-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque et nisl nec lorem scelerisque consectetur. Proin laoreet tristique dolor.</p>
                        </ReviewCard>
                    </CardsWrapper>
                </ReviewsWrapper>
            </div>
