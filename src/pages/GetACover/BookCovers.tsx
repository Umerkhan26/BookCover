...
const BookCoverDesigns = () => {
  return (
    <GridContainer>
      <Link to="/fictionCover" style={{ textDecoration: "none" }}>
        <GridItem>
      ...
      <Link to="/nonFiction" style={{ textDecoration: "none" }}>
        <GridItem>
      ...
      <Link to="/bookCoverRedesign" style={{ textDecoration: "none" }}>
        <GridItem>
      ...
      <Link to="/illustrated" style={{ textDecoration: "none" }}>
        <GridItem>
      ...
      <Link to="/audioBookCover" style={{ textDecoration: "none" }}>
        <GridItem>
      ...
      <Link to="/logoBrand" style={{ textDecoration: "none" }}>
