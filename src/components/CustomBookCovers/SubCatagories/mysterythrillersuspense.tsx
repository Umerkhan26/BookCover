...
const selectedIndices = [14, 28, 20, 38, 34, 23, 2, 9, 40, 10, 30];
...
const MysteryThrillerSuspense: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Mystery, Thriller & Suspense Book Covers</title>
        <meta
          name="description"
          content="Browse mystery, thriller & suspense book covers."
        />
      </Helmet>
      <PortfolioContainer>
...
export default MysteryThrillerSuspense;
