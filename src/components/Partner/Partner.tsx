        ...
        steps={[
          {
            ...
            title: "Approval",
            description:
              "After being approved, you’ll get a unique referral link to promote our services.",
          },
          {
            number: "02",
            title: "Personal dashboard",
            description:
              "You’ll get access to your personal dashboard, where you can check stats on clicks, sign-ups, and purchases of your referred clients, track your commissions, as well as access promotional banners.",
          },
          {
            number: "03",
            title: "Referred client",
            description:
              "A referred client is assigned to you, as an affiliate, so you’ll get a 10% from each order a referred customer makes.",
          },
          {
            number: "04",
            title: "Commissions",
...
Work"
        ...
        steps={[
          {
            number: "01",
            title: "Reach out to us to discuss reselling possibilities",
            description:
              "After being approved, you’ll get a unique referral link to promote our services",
          },
          {
            number: "02",
            title: "Get approved based on the target audience match",
            description:
          ...
          {
            number: "03",
            title: "Become an authorized reseller",
            description:
